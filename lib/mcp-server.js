  ...
  const server = new McpServer(
    ...
    },
    {
      instructions: [
        ...
        "For shell: run_command (waits briefly then may background; output default ~8k tail), get_command_output to fetch more (max_output_chars=32000 or 0=full retained buffer up to 100k), stop_command. Prefer short tails; only extend when needed. Some dangerous commands are blocked.",
